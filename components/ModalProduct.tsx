    ...
    <div className="md:flex gap-10">
      ...
      <div className="md:w-2/3">
        <div className="flex justify-end cursor-pointer">
          <button type="button" className="absolute top-2 right-2 md:top-5 md:right-5" onClick={handleChangeModal}>
            <svg
        ...
        <div className="flex gap-4 mt-5">
          <button type="button" onClick={() => count > 1 && setCount(count - 1)}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
          ...
          <button type="button" onClick={() => count < 10 && setCount(count + 1)}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
